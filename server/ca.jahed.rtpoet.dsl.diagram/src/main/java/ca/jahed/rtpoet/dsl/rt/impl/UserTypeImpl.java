 ...
 * </p>
 * <ul>
 *   <li>{@link ca.jahed.rtpoet.dsl.rt.impl.UserTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserTypeImpl extends MinimalEObjectImpl.Container implements UserType
{
  ...
  {
    return RtPackage.Literals.USER_TYPE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RtPackage.USER_TYPE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RtPackage.USER_TYPE__NAME:
        return getName();
    }
