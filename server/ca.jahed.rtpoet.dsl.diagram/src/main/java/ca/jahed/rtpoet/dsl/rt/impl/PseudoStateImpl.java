 ...
 * </p>
 * <ul>
 *   <li>{@link ca.jahed.rtpoet.dsl.rt.impl.PseudoStateImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PseudoStateImpl extends StateImpl implements PseudoState
{
  ...
  {
    return RtPackage.Literals.PSEUDO_STATE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RtPackage.PSEUDO_STATE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RtPackage.PSEUDO_STATE__NAME:
        return getName();
    }
